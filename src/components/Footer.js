                ...
                <div className="footer-cols-wrap">
                    ...
                    <div className="footer-col">
                        ...
                        <ul className="social-links-ul">
                            <li><Link to='/'><FaFacebookF className="fa" />Facebook</Link></li>
                            <li><Link to='/'><FaTwitter className="fa" />Twitter</Link></li>
                            <li><Link to='/'><FaWhatsapp className="fa" />WhatsApp</Link></li>
                            <li><Link to='/'><FaVimeoV className="fa" />Vimeo</Link></li>
                        </ul>
                    </div>
                </div>
                <div className="copyright text-center">&copy; {year} | Relax-Inn | All Rights Reserved</div>
            </div>
        </footer>
    )
}
